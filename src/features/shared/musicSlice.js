  ...
  songsData: [
    {
      ...
      pathSong:
        "https://mp3-s1-m-zmp3.zmdcdn.me/b64fa99ef1da188441cb/8350285309253299135?authen=exp=1669884291~acl=/b64fa99ef1da188441cb/*~hmac=8cce4d79ac49467c99a5b864a6f97fec",
      duration: "04:27"
    },
    {
...
export const musicDataSlice = createSlice({
  ...
  reducers: {
    ...
    addSong: (state, action) => {
      console.log("state", state.songsData)
