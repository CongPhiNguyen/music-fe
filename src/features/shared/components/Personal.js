        ...
        <div className='main-home-personal'>
            ...
            <div className='main-home-personal__option'>
                <ul className='main-home-personal__option-list'>
                    <li onClick={() => { setOption("tongquan") }} className={`main-home-personal__option-item ${option === "tongquan" && 'main-home-personal__option-item-active'} `}>
                        Tổng quan
                    </li>
                    <li onClick={() => { setOption("baihat") }} className={`main-home-personal__option-item ${option === "baihat" && 'main-home-personal__option-item-active'} `}>
                        Bài hát
                    </li>
                    <li onClick={() => { setOption("playlist") }} className={`main-home-personal__option-item ${option === "playlist" && 'main-home-personal__option-item-active'} `}>
                        PlayList
                    </li>
                    <li onClick={() => { setOption("nghesi") }} className={`main-home-personal__option-item ${option === "nghesi" && 'main-home-personal__option-item-active'} `}>
                        Nghệ sĩ
                    </li>
