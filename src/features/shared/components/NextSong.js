    ...
    <div className="next-song">
      <div className="next-song__option">
        <div className="next-song__option-wrapper">
          <div
            onClick={() => {
              if (isLogin) dispatch(changeSelected({ type: "PLAYLIST" }))
            }}
            className={`${
              selected === "PLAYLIST"
                ? "next-song__option-wrapper-list-play"
                : "next-song__option-wrapper-history"
            }`}
          >
            Danh sách phát
          </div>
          <div
            onClick={() => {
              dispatch(changeSelected({ type: "HEARD_RECENTLY" }))
            }}
            className={`${
        ...
        <>
          {selectedPlaylist ? (
            <div className="next-song__box">
              <h2
                style={{ fontSize: "35px" }}
                className="next-song__last-heading"
              >
                {" "}
