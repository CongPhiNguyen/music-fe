...
import { FaCompactDisc, FaListAlt, FaMusic, FaBuromobelexperte, FaPhotoVideo } from "react-icons/fa"
        ...
        <div className='MainSidebar'>
            ...
            <div className='sildebar__library'>
                ...
                <div className='sidebar__library-bot'>
                    <div className='sidebar__library-bot-title'>
                        PLAY LIST
                    </div>
            ...
            <div className='sildebar__add-playlist'>
                <GrFormAdd style={{ color: "white", fontSize: '2rem', background: "white" }} />
