                ...
                <Row>
                    ...
                    <Col span={16}>
                        <div style={{ paddingTop: 50 }}>
                            <div style={{ color: "white", fontWeight: "700", fontSize: "14px" }}>Song</div>
                            <div style={{ color: "white", fontWeight: "700", fontSize: "60px" }}>{detail.title}</div>
                            <div style={{ display: "flex", alignItems: "center" }}>
                                <img className='song-header-avt' src={detail.artists
                                [0].thumbnailM} alt="Avatar" />
                                <div className='song-header-singer-name'>{detail.artists
                                [0].name} - {convertTime(detail.duration)} </div>
                            </div>
                        </div>
                    </Col>
                </Row>
            ...
            <div className='song-body'>
                <Row gutter={[24, 24]}>
                    <Col span={24}>
                        <div className='song-body-control'>
                            ...
                            <div className='song-body-heart'>
                                - <FaHeart style={{ margin: "0 10px", color: "#ff4d4f" }}></FaHeart> {detail.like}
                            </div>
                        </div>
                    </Col>
                    <Col span={8}>
                    ...
                    <Col span={16}>
                        ...
                        <pre className='lyric-content' dangerouslySetInnerHTML={{ __html: lyric.lyric }}>
                        </pre>
                    </Col>
